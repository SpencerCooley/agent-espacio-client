...
export default function ShareModal() {
  ...
  // When inherited, use the item's ID directly since it's accessible via parent's public URL
  const targetId = shareTarget?.publicMagicId || (shareTarget?.isInherited ? shareTarget?.id : null);
  ...
  const publicUrl = targetId
    ? `${typeof window !== 'undefined' ? window.location.origin : ''}/public/view/${targetId}`
    : '';
              ...
              <Box sx={{ mb: 3 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1 }}>
                  ...
                  <Switch
                    ...
                    disabled={shareTarget.isLoading}
                  />
                </Box>
